...
/**
 * Detector for identifying the kind of data stored in a given stream. This is
 * normally used on the first packet in a stream, to work out the type, if
 * recognised. Note - the mime types and descriptions should be kept roughly in
 * sync with those in Apache Tika
 */
public class OggStreamIdentifier {
	...
	// General types
	public static final OggStreamType OGG_GENERAL = new OggStreamType("application/ogg", "Ogg", Kind.GENERAL);
	public static final OggStreamType OGG_VIDEO = new OggStreamType("video/ogg", "Ogg Video", Kind.VIDEO);
	public static final OggStreamType OGG_AUDIO = new OggStreamType("audio/ogg", "Ogg Audio", Kind.AUDIO);
	public static final OggStreamType UNKNOWN = new OggStreamType("application/octet-stream", "Unknown", Kind.GENERAL);

	// Audio types
	public static final OggStreamType OGG_VORBIS = new OggStreamType("audio/vorbis", "Vorbis", Kind.AUDIO);
	public static final OggStreamType OPUS_AUDIO = new OggStreamType("audio/opus", "Opus", Kind.AUDIO);
	public static final OggStreamType OPUS_AUDIO_ALT = new OggStreamType("audio/ogg; codecs=opus", "Opus", Kind.AUDIO);
	public static final OggStreamType SPEEX_AUDIO = new OggStreamType("audio/speex", "Speex", Kind.AUDIO);
	public static final OggStreamType SPEEX_AUDIO_ALT = new OggStreamType("audio/ogg; codecs=speex", "Speex", Kind.AUDIO);
	public static final OggStreamType OGG_PCM = new OggStreamType("audio/x-oggpcm", "Ogg PCM", Kind.AUDIO);

	public static final OggStreamType NATIVE_FLAC = new OggStreamType("audio/x-flac", "FLAC", Kind.AUDIO);
	public static final OggStreamType OGG_FLAC = new OggStreamType("audio/x-oggflac", "FLAC", Kind.AUDIO);

	// Video types
	public static final OggStreamType THEORA_VIDEO = new OggStreamType("video/theora", "Theora", Kind.VIDEO);
	public static final OggStreamType THEORA_VIDEO_ALT = new OggStreamType("video/x-theora", "Theora", Kind.VIDEO);
	public static final OggStreamType DAALA_VIDEO = new OggStreamType("video/daala", "Daala", Kind.VIDEO);
	public static final OggStreamType DIRAC_VIDEO = new OggStreamType("video/x-dirac", "Dirac", Kind.VIDEO);
	public static final OggStreamType OGM_VIDEO = new OggStreamType("video/x-ogm", "Ogg OGM", Kind.VIDEO);

	public static final OggStreamType OGG_UVS = new OggStreamType("video/x-ogguvs", "Ogg UVS", Kind.VIDEO);
	public static final OggStreamType OGG_YUV = new OggStreamType("video/x-oggyuv", "Ogg YUV", Kind.VIDEO);
	public static final OggStreamType OGG_RGB = new OggStreamType("video/x-oggrgb", "Ogg RGB", Kind.VIDEO);

	// Metadata types
	public static final OggStreamType SKELETON = new OggStreamType("application/annodex", "Skeleton Annodex", Kind.METADATA);
	public static final OggStreamType CMML = new OggStreamType("text/x-cmml", "CMML", Kind.METADATA);
	public static final OggStreamType KATE = new OggStreamType("application/kate", "Kate", Kind.METADATA);
